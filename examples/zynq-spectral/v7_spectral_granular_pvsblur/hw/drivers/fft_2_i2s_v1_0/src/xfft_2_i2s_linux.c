...
typedef struct {
    ...
    XFft_2_i2s_uio_map maps[ MAX_UIO_MAPS ];
} XFft_2_i2s_uio_info;

/***************** Variable Definitions **************************************/
static XFft_2_i2s_uio_info uio_info;
...
static int uio_info_read_name(XFft_2_i2s_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XFft_2_i2s_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XFft_2_i2s_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XFft_2_i2s_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XFft_2_i2s_Initialize(XFft_2_i2s *InstancePtr, const char* InstanceName) {
	XFft_2_i2s_uio_info *InfoPtr = &uio_info;
